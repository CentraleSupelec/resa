...
const mapDispatchToProps = (dispatch) => ({
  ...
  toggleDisplayVideoAcquisitionRooms: () => dispatch(toggleDisplayVideoAcquisitionRooms()),
  toggleDisplayVideoConferenceRooms: () => dispatch(toggleDisplayVideoConferenceRooms()),
  toggleDisplayUnavailableRooms: () => dispatch(toggleDisplayUnavailableRooms()),
  toggleDisplayOpenSpaces: () => dispatch(toggleDisplayOpenSpaces()),
  toggleDisplayCampusAmong: (value) => dispatch(toggleDisplayCampusAmong(value)),
